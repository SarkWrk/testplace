...
for _k, _v in TS.import(script, script, "use-debounce-source") or {} do
	exports[_k] = _v
end
...
for _k, _v in TS.import(script, script, "use-defer-source") or {} do
	exports[_k] = _v
end
...
for _k, _v in TS.import(script, script, "use-spring") or {} do
	exports[_k] = _v
end
for _k, _v in TS.import(script, script, "use-tagged") or {} do
	exports[_k] = _v
end
...
for _k, _v in TS.import(script, script, "use-throttle-source") or {} do
	exports[_k] = _v
end
