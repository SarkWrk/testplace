import { LockedSource } from "@rbxts/pretty-vide-utils/out/utils";
 ...
 */
export declare function useAsyncCallback<T, U extends unknown[]>(callback: AsyncCallback<T, U>): LuaTuple<[LockedSource<AsyncState<T>>, (...args: U) => Promise<T>]>;
